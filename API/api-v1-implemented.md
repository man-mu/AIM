# AIM API v1 当前契约（Contract of Record）

> **本文档是前后端接口的唯一事实来源（Single Source of Truth）。**
>
> - 取代 `api-v1.md`（项目初始规划契约，部分内容已过时，仅作历史参考）
...
>
> 契约基线时间：2026-07-31（依据：后端实际实现 + 前端 mock handlers 全量提取核对）
...
## 附录 A：与 api-v1.md 的关系

- `api-v1.md` 是项目初始规划契约（2026-07-11），**部分内容已过时**（端口 8080、logout body、validate 含 deviceId、friend 路径、message 游标分页等）
- 本文件自 2026-07-31 起为唯一事实来源；`api-v1.md` 保留仅作历史参考
